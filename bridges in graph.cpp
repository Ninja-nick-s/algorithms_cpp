...
int tin = 0;
void dfscall(int start ,int parent , int timer[] , int low[]){	//This is function to find bridges
	vis[start] = true;											//in graph
...
/*
	bridges are edges in graph if we take them out our graph gets divided into different components
*/
void graph(){
