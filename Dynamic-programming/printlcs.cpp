...
string printlcs(string a , string b,int n,int m){
    int dp[n+1][m+1];
/*  Here to find longest common subsequence we need to first find 
    dp array of length of lcs
*/
    //initialisation
    rep(i,0,n+1){
        dp[i][0] = 0;
...
/*  now we need to run an algoritm to find the common subsequence */
